...
// Função quick sort para a esquerda e direita das partições
...
// Função partition para particionar o conjunto de dados
int partition(int *vet, int inicio, int fim)
{
	...
	};	// Fim do While que caminha nas duas direções
	vet[inicio] = vet[dir];
	vet[dir] = pivot;
	return dir;
